...
public class TheLocustEvolutionObservationOnEntityTickUpdateProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		Entity player = null;
		if (entity instanceof TheLocustEvolutionObservationEntity) {
			...
			if (!world.getEntitiesOfClass(ServerPlayer.class, AABB.ofSize(new Vec3(x, y, z), 60, 60, 60), e -> true).isEmpty()) {
				...
				if (entity instanceof TheLocustEvolutionObservationEntity) {
					((TheLocustEvolutionObservationEntity) entity).setAnimation("escape");
				}
